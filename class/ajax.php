...
class Hrm_Ajax
{
    ...
    public function partial_payment_delete()
    {
    ...
    public function partial_payment_cancel()
    {
        check_ajax_referer('hrm_nonce');
        $data  = $this->edit_query($_POST['table'], $_POST['id']);
    ...
    public function partial_payment_update()
    {
        check_ajax_referer('hrm_nonce');
        $data  = $this->edit_query($_POST['table'], $_POST['id']);
    ...
    public function get_clients_project()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function client_delete()
    {
        ...
        if ($client_delete) {
            ...
            wp_send_json_error(array(
                'error_msg' => __('Failed to delete client!', 'hrm'),
            ));
        }
    }
    ...
    public function punch_form_status()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function hrm_profile_pic_del()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function view_pagination()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function delete_inbox_file()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function hrm_delete_file()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function user_task_rating_content()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function hrm_post_delete()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function single_tab_user_role()
    {
        check_ajax_referer('hrm_nonce');
        $post = $_POST;
    ...
    public function edit_attendance_save()
    {
        check_ajax_referer('hrm_nonce');
        $post = $_POST;
    ...
    public function new_punch_in()
    {
        ...
        if ($punch) {
            ...
            wp_send_json_success(array(
                'content' => ob_get_clean(),
                'success_msg' => __('Successfully Updated Punch', 'hrm'),
            ));
        }
    }
    ...
    public function project_delete()
    {
        ...
        if ($project_delete) {
            ...
            wp_send_json_error(array(
                'error_msg' => __('Failed to delete employee', 'hrm'),
            ));
        }
    }
    ...
    public function delete_employee()
    {
        ...
        if (!isset($postdata['hrm_check']) || !is_array($postdata['hrm_check'])) {
            wp_send_json_error(array(
                'success_msg' => __('Failed to delete employee', 'hrm'),
            ));
        }
        $delete_user = false;
        if (hrm_user_can_access($postdata['tab'], null, 'delete')) {
            ...
            wp_send_json_error(array(
                'error_msg' => __('You do not have permission delete employee', 'hrm'),
            ));
        }
        ...
        if ($delete_user) {
            ...
            wp_send_json_success(array(
                'content' => ob_get_clean(),
                'success_msg' => __('Successfully delete employee', 'hrm'),
            ));
        } else {
            wp_send_json_error(array(
                'error_msg' => __('Failed to delete employee', 'hrm'),
    ...
    public function find_project_worker()
    {
    ...
    public function insert_sub_task()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function insert_project_user_role($posted, $project_id)
    {
        global $wpdb;
    ...
    public function insert_user($project_id, $user_id, $role)
    {
        global $wpdb;
        $table = $wpdb->prefix . 'hrm_user_role';
        $data = array(
    ...
    public function add_form_generator()
    {
        ...
        } elseif (class_exists($class_nam)) {
            $new_instance = new $class_nam();
            $data = $new_instance->$function_nam();
        } elseif (function_exists($function_nam)) {
            $data = $function_nam();
        }
    ...
    public function user_role_edit_form_prepare()
    {
        check_ajax_referer('hrm_nonce');
    ...
    public function hrm_autocomplete_action()
    {
    ...
    public function singel_form_add()
    {
        check_ajax_referer('hrm_nonce');
