...
class Hrm_Settings
{
    ...
    public function get_emp_meta($id, $key, $status = true)
    {
        return get_user_meta($id, $key, $status);
    }

    public function get_current_page_url($page, $tab, $subtab)
    {
    ...
    public function show_tab_page($page, $tab, $subtab, $nested_tab = '')
    {
        if (!$tab) {
    ...
    public function show_sub_tab_page($page, $tab, $subtab)
    {
        $menu = hrm_page();
    ...
    public function select_field($name, $element)
    {
        $extra_field = '';
    ...
    public function multiple_select_field($name, $element)
    {
        $extra_field = '';
        $id          = isset($element['id']) ? esc_attr($element['id']) : esc_attr($name);
        $class       = isset($element['class']) ? esc_attr($element['class']) : esc_attr($name);
    ...
    public function text_field($name = '', $element)
    {
        if (empty($name)) {
            return;
        }
        ...
        $html .= $input_before;
        $html .= sprintf(
            '<input type="text" name="%1$s" value="%2$s" placeholder="%3$s" class="%4$s" id="%5$s" %6$s %7$s />',
            $name,
            $value,
            $placeholder,
            $class,
    ...
    public function hidden_field($name = '', $element)
    {
        if (empty($name)) {
            return;
        }
        ...
        $html = sprintf(
            '<input type="hidden" name="%1$s" value="%2$s" class="%3$s" id="%4$s" %5$s />',
            $name,
            $value,
            $class,
            $id,
    ...
    public function radio_field($name = '', $element)
    {
        if (empty($name)) {
            return;
        }
    ...
    public function checkbox_field($name = '', $element)
    {
        if (empty($name)) {
            return;
        }
    ...
    public function textarea_field($name = '', $element)
    {
        if (empty($name)) {
            return;
        }
        ...
        $html = sprintf('<label for="%1s">%2s<em>%3s</em></label>', $id, $label, $required);
        $html .= sprintf(
            '<textarea name="%1$s" class="%2$s" id="%3$s" %4$s %5$s >%6$s</textarea>',
            $name,
                $class,
            $id,
            $disabled,
    ...
    public function hrm_tinymce($element)
    {
    ...
    public function multiple_field_inside_this_wrap($element)
    {
    ...
    public function multiple_field_inside_this_wrap_close($element)
    {
        $parent_wrap_start_tag = isset($element['parent_wrap_start_tag']) ? $element['parent_wrap_start_tag'] : 'div';
        ob_start();
    ...
    public function descriptive_field($element)
    {
        $extra_field = '';
        $id          = isset($element['id']) ? esc_attr($element['id']) : '';
        $label       = isset($element['label']) ? esc_attr($element['label']) : '';
    ...
    public function get_serarch_form($form, $heading = null)
    {
    ...
    public function hidden_form_generator($form)
    {
        $form['action']       = isset($form['action']) ? $form['action'] : '';
        $form['table_option'] = isset($form['table_option']) ? $form['table_option'] : '';
    ...
    public function visible_form_generator($form)
    {
        $form['action']       = isset($form['action']) ? $form['action'] : '';
        $form['table_option'] = isset($form['table_option']) ? $form['table_option'] : '';
        $form['header']       = isset($form['header']) ? $form['header'] : '';
    ...
    public function form_field_only($form)
    {
        $form['action']       = isset($form['action']) ? $form['action'] : '';
        $form['table_option'] = isset($form['table_option']) ? $form['table_option'] : '';
        $form['header']       = isset($form['header']) ? $form['header'] : '';
    ...
    public function table($table)
    {
        ...
        } elseif (isset($table['data_table']) && !$table['data_table']) {
            $datatable = '';
        } else {
            $datatable = 'hrm-data-table';
        }
    ...
    public function table_generate($table)
    {
    ...
    public function data_formating($table)
    {
    ...
    public function hrm_query($table, $limit = 0, $pagenum = 1)
    {
        global $wpdb;
    ...
    public function edit_query($table, $id)
    {
        global $wpdb;
    ...
    public function update_table_option($table_option_name, $table_option)
    {
        return update_option($table_option_name, $table_option);
    }


    public function search_query($post, $limit, $pagenum)
    {
    ...
    public function pagination_query_arg()
    {
    ...
    public function pagination($total, $limit = 1, $pagenum = false)
    {
    ...
    public function conditional_query_val($table, $fields = '*', $compare = array(), $row = false, $limit = 0, $pagenum = 1)
    {
    ...
    public function send($to, $subject, $message, $sender_id)
    {
     ...
     *
     */
    public function month($selected = false)
    {
        $months = array(
            '-1' => __('--None--', 'hrm'),
            1    => __('january', 'hrm'),
    ...
    public function year($selected = false)
    {
