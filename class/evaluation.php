...
class Hrm_Evaluation
{
    ...
    public function get_project_by_manager()
    {
        global $wpdb;
    ...
    public function search_rating_record($post, $limit, $pagenum)
    {
    ...
    public function rating_recored($limit, $pagenum)
    {
        $offset  = ($pagenum - 1) * $limit;
        $args = array(
            'post_type'      => 'hrm_task',
    ...
    public function jonin_user_role_table($join)
    {
        global $wpdb;
    ...
    public function get_project_where_user_role($where, &$wp_query)
    {
        global $wpdb;
    ...
    public function get_project_by_author()
    {
        $user_id = get_current_user_id();
    ...
    public function get_user_by_project_id($project_id)
    {
    ...
    public function user_task_content($project_id, $user_id)
    {
    ...
    public function get_outstnding_task($project_id, $user_id, $subtab = null)
    {
        global $wpdb;
    ...
    public function new_task_rating($post)
    {
    ...
    public function new_inserted_task_rating($project_id, $assing_to)
    {
        if (!$assing_to) {
            return false;
        }
    ...
    public function reduce_task_rating($project_id, $assing_to)
    {
        $tasks = $this->count_total_task($project_id, $assing_to);
        $total_task = $tasks->found_posts;
    ...
    public function count_total_task($project_id, $assing_to = false)
    {
        $args = array(
            'post_type'      => 'hrm_task',
            'post_status'    => array( 'publish', 'future' ),
    ...
    public function update_task_rating($post)
    {
    ...
    public function parent_rating_delete($project_id)
    {
        $args = array(
            'post_parent' => $project_id,
