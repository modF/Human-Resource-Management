...
class HRM_Client
{
    ...
    public function get_clients($limit = -1)
    {
        $clients = array();
        $args = array(
            'meta_query' => array(
    ...
    public function new_client_form($client_id = false)
    {
    ...
    public function new_client($postdata)
    {
    ...
    public function udpate_client_meta($client_id, $post)
    {
    ...
    public function new_client_partial_payment_form($data = false)
    {
        $redirect = (isset($_POST['hrm_dataAttr']['redirect']) && !empty($_POST['hrm_dataAttr']['redirect'])) ? $_POST['hrm_dataAttr']['redirect'] : '';
    ...
    public function update_partial_payment($befor_data, $post)
    {
        global $wpdb;
    ...
    public function partial_payment_tr_congent($partial_payment)
    {
        ob_start(); ?>
        <td>
    ...
    public function partial_payment_total($currency_symbol, $partial_total_amount)
    {
        ob_start(); ?>
        <td></td>
    ...
    public function partial_payment_table($partial_payments)
    {
        ob_start(); ?>
    ...
    public function client_total_pay($partial_payments)
    {
        $partial_total_amount = 0;
        foreach ($partial_payments as $key => $partial_payment) {
            $partial_total_amount = $partial_total_amount + $partial_payment->amount;
    ...
    public function partial_client_payemnt_summery($currency_symbol, $client_pay, $client_due)
    {
        ob_start(); ?>
    ...
    public function cancel_partial_payment_update($befor_data, $post)
    {
        $table = $post['table'];
        $condition = array(
            'client_id'  => $befor_data['client_id'],
    ...
    public function cancel_partial_payment_delete($befor_data, $post)
    {
        global $wpdb;
        $table = $wpdb->prefix . $post['table'];
