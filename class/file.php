...
class HRM_File
{
    ...
    public function get_assing_user($post_id)
    {
    ...
    public function get_share_files($post_author = false, $post_parent = false)
    {
        $args = array(
    ...
    public function searching_file_posts($post, $limit, $pagenum)
    {
    ...
    public function get_share_file_posts($limit = 0, $pagenum = 1, $post_author = false)
    {
    ...
    public function search_file_posts_inbox($post, $limit, $pagenum, $inbox_user_id)
    {
        $offset  = ($pagenum - 1) * $limit;
    ...
    public function get_file_posts_inbox($inbox_user_id)
    {
    ...
    public function file_upload_form($post = false)
    {
        if ($post) {
            $author = get_current_user_id();
    ...
    public function file_user_set($post)
    {
    ...
    public function delete_inbox_file($file_ids, $user_id)
    {
