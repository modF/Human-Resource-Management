...
class Hrm_Employee
{
    ...
    public function after_inset_information($post, $last_inserted_id)
    {
    ...
    public function get_salary_message_body($last_recored, $post, $to_user)
    {
    ...
    public function delete_file($file_id, $force = true, $employee_id)
    {
    ...
    public function after_ajax_upload($response, $file, $post)
    {
    ...
    public function pim_to_employer($page = null)
    {
    ...
    public function current_user_task($user_id, $subtab)
    {
        global $wpdb;
        ...
        } elseif (isset($subtab) && $subtab == 'completed_task') {
    ...
    public function delete_employee($users_id = array())
    {
        $delte_user = false;
    ...
    public function edit_my_info($postdata, $table_options)
    {
        $id = $postdata['user_id'];
        $user_id = false;
    ...
    public function get_employee($employee_id, $table)
    {
    ...
    public function education($field_data = null)
    {
    ...
    public function work_experience($field_data = null)
    {
        $redirect = (isset($_POST['hrm_dataAttr']['redirect']) && !empty($_POST['hrm_dataAttr']['redirect'])) ? $_POST['hrm_dataAttr']['redirect'] : '';
        if ($field_data !== null) {
            $hidden_form['id'] = array(
    ...
    public function personal_skill($field_data = null)
    {
        $redirect = (isset($_POST['hrm_dataAttr']['redirect']) && !empty($_POST['hrm_dataAttr']['redirect'])) ? $_POST['hrm_dataAttr']['redirect'] : '';
        if ($field_data !== null) {
            $hidden_form['id'] = array(
    ...
    public function personal_language($field_data = null)
    {
        $redirect = (isset($_POST['hrm_dataAttr']['redirect']) && !empty($_POST['hrm_dataAttr']['redirect'])) ? $_POST['hrm_dataAttr']['redirect'] : '';
        if ($field_data !== null) {
            $hidden_form['id'] = array(
    ...
    public function competency($competency_code = null)
    {
        $competency = array(
            '0' => __('Poor', 'hrm'),
            '1' => __('Basic', 'hrm'),
    ...
    public function fluency($fluency_code = null)
    {
        $fluency = array(
            '0' => __('Writing', 'hrm'),
            '1' => __('Reading', 'hrm'),
    ...
    public function salary_search_query($search_post, $limit, $pagenum)
    {
    ...
    public function salary($field_value = null)
    {
        $redirect = (isset($_POST['hrm_dataAttr']['redirect']) && !empty($_POST['hrm_dataAttr']['redirect'])) ? $_POST['hrm_dataAttr']['redirect'] : '';
...
*/
    ...
    public function pay_frequency($frequency = null)
    {
        $frequencys = array(
            '0' => __('Bi Weekly', 'hrm'),
            '1' => __('Hourly', 'hrm'),
