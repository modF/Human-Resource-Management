...
class Hrm_Employeelist
{
    ...
    public function new_employee_form($employer = null)
    {
        ...
        $hidden_form['joined_date'] = array(
            'label' =>  __('Hire Date', 'hrm'),
            'type'  => 'text',
            'class' => 'hrm-datepicker',
            'value' => get_user_meta($employer_id, '_joined_date', true)
        );

        $hidden_form['termination_date'] = array(
            'label' =>  __('Termination Date', 'hrm'),
            'type'  => 'text',
            'class' => 'hrm-datepicker',
            'value' => get_user_meta($employer_id, '_termination_date', true)
        );
        ...
        'label' => __('RFID Serial', 'hrm'),
            'type'  => 'textarea',
            'value' => get_user_meta($employer_id, '_rfid_serial', true)
        );

        $hidden_form['whitelisted'] = array(
                'label' => __('Allow Logins from Any IPs', 'hrm'),
        'type'  => 'select',
        'option' => array(
                   'yes' => 'Enable',
                   'no' => 'Disable'
            ),
                'selected' => get_user_meta($employer_id, '_whitelisted', true)
        );
    ...
    public function employeer_search_query($post, $limit, $pagenum)
    {
